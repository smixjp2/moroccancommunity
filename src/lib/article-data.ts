...
export const articles: Article[] = [
  {
    ...
    content: `
        <blockquote class="border-l-4 border-primary pl-6 text-xl italic text-foreground">
        ...
        <h2 class="font-headline text-2xl font-bold mt-8">Une valorisation sous surveillance</h2>
        <p>
        ...
        <div class="my-8 p-6 rounded-lg bg-muted/50">
            <h3 class="font-headline text-xl font-semibold mb-4">Objectif de cours et potentiel d’appréciation</h3>
            <p class="mb-4 text-muted-foreground">Les projections établies par certaines analyses de marché situent un objectif de cours à environ <strong class="text-foreground">2 419 DH pour 2026</strong>, ce qui représenterait un potentiel de hausse de l’ordre de <strong class="text-foreground">31,5 %</strong> par rapport à fin décembre 2025.</p>
        ...
        <h2 class="font-headline text-2xl font-bold">Facteurs macro-sectoriels favorables</h2>
        <p>
        ...
        <div class="my-8 p-6 rounded-lg border">
             <h2 class="font-headline text-2xl font-bold mb-4">Analyse fondamentale du titre</h2>
            
            <h4 class="font-semibold text-lg mt-4">Valorisation et rendement</h4>
            ...
            <h4 class="font-semibold text-lg mt-4">Points forts structurels</h4>
        ...
        <div class="my-8 p-6 rounded-lg bg-destructive/10 border-destructive">
            <h3 class="font-headline text-xl font-semibold text-destructive">Risques à considérer</h3>
            <ul class="list-disc pl-5 mt-2 space-y-2 text-muted-foreground">
                <li><strong class="text-foreground">Endettement élevé :</strong> Le groupe affichait un endettement net important à fin septembre 2025, ce qui peut limiter sa flexibilité financière.</li>
                <li><strong class="text-foreground">Corrélation avec le cycle immobilier :</strong> La sensibilité du titre à l’évolution du secteur immobilier expose l’action aux retournements cycliques.</li>
                <li><strong class="text-foreground">Concurrence et diversification limitée :</strong> Une présence modeste sur les granulats ou le béton prêt à l’emploi restreint la diversification des revenus.</li>
            </ul>
        </div>

        <h2 class="font-headline text-2xl font-bold">Place de LafargeHolcim dans une allocation actions</h2>
        <p>
        ...
        <div class="mt-12 p-6 rounded-lg bg-primary/10 border-primary">
            <h4 class="font-headline text-xl font-semibold mb-2">En résumé</h4>
             <ul class="list-disc pl-5 mt-2 space-y-2 text-muted-foreground">
  ...
  },
  {
    ...
    content: `
        ...
        <h2 class="font-headline text-2xl font-bold mt-8">Une industrie des OPCVM qui évolue</h2>
        <p>
        ...
        <div class="my-8 p-6 rounded-lg bg-muted/50">
            <h3 class="font-headline text-xl font-semibold mb-4">Nouveaux produits : élargir l’univers d’investissement</h3>
            <div class="space-y-4">
                <div>
                    <h4 class="font-semibold">OPCVM indiciels cotés (ETF)</h4>
                    <p class="text-muted-foreground">Ces fonds répliquent un indice boursier et sont négociés en continu, facilitant l'investissement indiciel pour tous.</p>
                </div>
                <div>
                    <h4 class="font-semibold">OPCVM libellés en devises</h4>
                    <p class="text-muted-foreground">Permet aux MRE d'investir sans risque de change et attire les flux internationaux, renforçant la liquidité.</p>
                </div>
                 <div>
                    <h4 class="font-semibold">OPCVM à compartiments et participatifs</h4>
                    <p class="text-muted-foreground">Offre plus de flexibilité de gestion et ouvre la voie à des fonds conformes à la finance islamique.</p>
                </div>
            </div>
        </div>
        <h2 class="font-headline text-2xl font-bold">Une réforme conditionnée par la mise en œuvre réglementaire</h2>
        <p>
        ...
        <div class="my-8 p-6 rounded-lg border grid md:grid-cols-2 gap-8">
             <div>
                <h3 class="font-headline text-xl font-bold mb-4">Implications pour la Bourse</h3>
             ...
             <div>
                 <h3 class="font-headline text-xl font-bold mb-4">Opportunité pour l'Écosystème</h3>
        ...
        <div class="mt-12 p-6 rounded-lg bg-primary/10 border-primary">
            <h4 class="font-headline text-xl font-semibold mb-2">Conclusion</h4>
  ...
  },
  {
    ...
    content: `
        ...
        <h2 class="font-headline text-2xl font-bold mt-8">Une phase post-IPO davantage axée sur la création de valeur</h2>
        <p>
        ...
        <div class="my-8 p-6 rounded-lg bg-muted/50">
            <h3 class="font-headline text-xl font-semibold mb-4">Activité de transfert d’argent : le cœur du modèle</h3>
            <p class="mb-4 text-muted-foreground">L’activité historique de Cash Plus — le transfert d’argent national et international — constitue encore le socle du modèle économique, représentant environ 63 % du chiffre d’affaires. Elle reste fortement corrélée aux flux domestiques et à ceux de la diaspora marocaine.</p>
         ...
         <h2 class="font-headline text-2xl font-bold">Comptes de paiement : un relais de croissance stratégique</h2>
        <p>
        ...
        <ul class="list-disc pl-5 mt-2 space-y-1">
         ...
         <p class="mt-4">Si ce segment continue de croître, il peut devenir un moteur de valorisation essentiel pour Cash Plus, en modifiant la perception du marché sur la capacité du groupe à générer des revenus récurrents dans un secteur où l’usage des services digitaux s’impose progressivement.</p>
        
        <div class="my-8 p-6 rounded-lg border">
             <h2 class="font-headline text-2xl font-bold mb-4">Ressources financières : levier pour la feuille de route</h2>
            <p class="mb-4">Un autre levier est la structure financière renforcée de l’entreprise. Cash Plus a levé environ 200 millions de dirhams (MDH) lors de sa préparation à l’IPO, puis environ 400 MDH supplémentaires au moment de l’introduction.</p>
            ...
            <ul class="list-disc pl-5 mt-2 space-y-1">
             ...
             <p class="mt-4">La capacité à convertir ces moyens financiers en croissance opérationnelle reste un point à suivre de près.</p>
        </div>
        <div class="my-8 p-6 rounded-lg bg-card grid md:grid-cols-2 gap-8">
             <div>
                <h3 class="font-headline text-xl font-bold mb-4">Lecture boursière</h3>
             ...
             <div>
                 <h3 class="font-headline text-xl font-bold mb-4">Lecture économique</h3>
  ...
  },
  {
    ...
    content: `
        ...
        <h2 class="font-headline text-2xl font-bold mt-8">Un cycle haussier désormais structurel</h2>
        <p>
        ...
        <div class="my-8 p-6 rounded-lg bg-muted/50">
            <h3 class="font-headline text-xl font-semibold mb-4">Le rôle central du contexte macroéconomique</h3>
            <p class="mb-4 text-muted-foreground">L’un des principaux soutiens du marché actions marocain réside dans l’évolution favorable de l’environnement macroéconomique. Les perspectives pour 2026 reposent notamment sur :</p>
            <ul class="list-disc pl-5 mt-2 space-y-1">
            ...
            <p class="mt-4">Ce contexte améliore la visibilité des entreprises et réduit l’incertitude, un élément clé pour les marchés financiers.</p>
        </div>
        <h2 class="font-headline text-2xl font-bold">La progression des bénéfices comme moteur principal</h2>
        <p>
        ...
        <div class="my-8 p-6 rounded-lg border">
             <h2 class="font-headline text-2xl font-bold mb-4">Valorisation du marché : un niveau cohérent</h2>
            <p class="mb-4">Après plusieurs années de hausse, la question de la valorisation devient centrale. Le PER moyen du marché marocain se situe autour de 19 fois les bénéfices attendus, un niveau jugé cohérent compte tenu :</p>
            <ul class="list-disc pl-5 mt-2 space-y-1">
            ...
            <p class="mt-4">Ce niveau de valorisation ne traduit pas, à ce stade, une situation de surévaluation excessive du marché.</p>
        </div>
        <h2 class="font-headline text-2xl font-bold">Sélectivité et différenciation sectorielle</h2>
        <p>
        ...
        <div class="my-8 p-6 rounded-lg bg-card grid md:grid-cols-2 gap-8">
             <div>
                ...
                <p class="mt-2">Un marché actions bien orienté favorise :</p>
                <ul class="list-disc pl-5 mt-2 space-y-1">
             ...
             <div>
                ...
                <p class="mt-2">La Bourse devient ainsi un levier indirect mais essentiel du développement économique.</p>
            </div>
        </div>
        <div class="mt-12 p-6 rounded-lg bg-primary/10 border-primary">
            <h4 class="font-headline text-xl font-semibold mb-2">Conclusion</h4>
  ...
  },
  {
    ...
    content: `
        ...
        <div class="my-8 p-6 rounded-lg bg-muted/50">
            <h3 class="font-headline text-xl font-semibold mb-4">Pourquoi l’hôpital avait été temporairement fermé ?</h3>
            <p class="mb-4 text-muted-foreground">La fermeture provisoire du complexe n’était pas liée à un incident médical ou à un problème de sécurité majeur, mais plutôt à des non-conformités administratives et techniques relevées lors des contrôles.</p>
            ...
            <p class="mt-4">Une fois ces exigences satisfaites, toutes les autorisations de réouverture ont été officiellement délivrées.</p>
        </div>

        <h2 class="font-headline text-2xl font-bold">Un établissement stratégique dans l’offre de soins à Rabat</h2>
        <p>
        ...
        <div class="my-8 p-6 rounded-lg border">
             <h2 class="font-headline text-2xl font-bold mb-4">Lecture boursière : quel impact pour Akdital en Bourse ?</h2>
            <p class="mb-4">Le point clé pour les investisseurs est que Akdital est une société cotée à la Bourse de Casablanca. À ce titre, la réouverture du complexe hospitalier de Rabat revêt une importance particulière sur plusieurs plans :</p>
            
            <h4 class="font-semibold text-lg mt-4">Visibilité et crédibilité</h4>
            ...
            <h4 class="font-semibold text-lg mt-4">Impact sur les fondamentaux</h4>
            ...
            <h4 class="font-semibold text-lg mt-4">Message envoyé au marché</h4>
        ...
        <div class="my-8 p-6 rounded-lg bg-card">
             <h2 class="font-headline text-2xl font-bold mb-4">Lecture économique : un enjeu au-delà d’Akdital</h2>
            ...
            <p class="mt-4">Elle s’inscrit aussi dans la dynamique nationale de modernisation du système de santé, encouragée par les réformes en cours et l’extension de la couverture médicale.</p>
        </div>
