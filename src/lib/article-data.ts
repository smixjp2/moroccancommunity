...
export const articles: Article[] = [
  {
    ...
    date: "2026-01-20",
    imageUrl: "https://picsum.photos/seed/concrete/1080/608",
    ...
    content: `
        ...
        <p>Les projections établies par certaines analyses de marché situent un objectif de cours à environ <strong>2 419 DH pour 2026</strong>, ce qui représenterait un potentiel de hausse de l’ordre de <strong>31,5 %</strong> par rapport à fin décembre 2025.</p>
        ...
        <ul>
            <li><strong>Endettement élevé :</strong> Le groupe affichait un endettement net important à fin septembre 2025, ce qui peut limiter sa flexibilité financière.</li>
            <li><strong>Corrélation avec le cycle immobilier :</strong> La sensibilité du titre à l’évolution du secteur immobilier expose l’action aux retournements cycliques.</li>
            <li><strong>Concurrence et diversification limitée :</strong> Une présence modeste sur les granulats ou le béton prêt à l’emploi restreint la diversification des revenus.</li>
        </ul>
